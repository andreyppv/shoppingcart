...
class TemplateController extends FrontController {
    ...
    public function invitation()
    {
        ...
        $templates = $this->_getInstance($serviceType)->paginate($this->_pageLimit);
        $totalCount = $this->_getInstance($serviceType)->get()->count();
    ...
    public function upload()
    {
        ...
        {
            if(($saved = MyCart::hasSavedTemplate()) === false)
            {
                return redirect('/');     
            }
            else
