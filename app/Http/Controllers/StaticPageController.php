...
class StaticPageController extends FrontController 
{
    ...
    {
        $this->page_title = 'How to order';
        $this->page_class = 'how-order-page';
        $this->page_menu = 'how_order';
        return $this->view('static.howToOrder');
    }
    
    public function printFeature()
    {
        $this->page_title = 'Print Feature Information';
        $this->page_class = 'how-order-page';
        $this->page_menu = 'print_feature';
        return $this->view('static.printFeature');
    }
    ...
    {
        $this->page_title = 'Print File Setup Instruction';
        $this->page_class = 'how-order-page';
        $this->page_menu = 'file_setup';
        return $this->view('static.fileSetup');
    }
