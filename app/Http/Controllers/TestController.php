...
class TestController extends BasicController 
{
    ...
    {
        $aweber = new AWeber(); 
        if($aweber->removeSubscriber('daipangchi@gmail.com'))
        {
            echo 'success';
        }        
        else
    ...
    public function index()
    {
        ...
        /*$card = Omnipay::creditCard([
                    ...
                    'billingPostcode'       => '77027',
                    'billingState'          => 'TX',
        ]);*/    
        $card = Omnipay::creditCard([
                    'firstName' => 'Example',
                    'lastName' => 'User',
                    'number' => '4716680890882851',
                    'expiryMonth'           => '01',
                    'expiryYear'            => '2020',
                    'cvv'                   => '123',
                    'billingAddress1'       => '1 Scrubby Creek Road',
        ...
        //am 375282325004951
        //TX 77027
        /*$response = Omnipay::createCard(array(
            'card' => $card,
            'payerId' => 'andreypp28',
        ))
        ->send();
        ...
        $response = Omnipay::purchase(array(
            ...
            'card'          => $card,
            //'cardReference' => 'CARD-2UD578334L110203TK5GZ5YA'
        ))
        ->setItems($items)
        ->send();
