...
class AdminController extends BasicController 
{
    ...
    protected function uploadImage($file, $path='') {
        ...
        {     
            ...
            $fileName = preg_replace('/\s+/', '_', strtolower($file->getClientOriginalName()));
    ...
    protected function restrictByRole($userType = USER_ADMIN)
    {
        if($this->current_user->user_type != $userType)
        {
            Template::set_message('Sorry, You don\'t have permission to access that page.', 'danger');
            force_redirect(URL::previous());
        }
