...
class OrderController extends AdminController {
    ...
    public function __construct()
    {
        ...
        $this->restrict_any(array('sales.order.manage', 'sales.order.view', 'sales.order.view.assigned'));
    }
    ...
    */
    ...
    {              
        ...
        //where
        $orders = null;
        if($this->current_user->has_any_permission(array('sales.order.manage', 'sales.order.view'), true))
        {
    ...
    {    
        ...
        else //update status
        {
            ...
            else
            {
                ...
                $mailTemplate = '';
                $mailTitle = 'RockDesign Notification';
                if($newStatus == JOB_FILE_ISSUE) {
                    $mailTemplate = 'emails.orders.orderFileIssue';   
                    $mailTitle = 'RockDesign File Issues Notification';
                } else if($newStatus == JOB_WAITING_FILE) {
                    $mailTemplate = 'emails.orders.orderWaitingFile';
                } else if($newStatus == JOB_IN_PRODUCTION) {
                    $mailTemplate = 'emails.orders.orderInProduction';
                }
                ...
                if($mailTemplate != '')
                {
                    ...
                    $this->sendMail($mailTemplate, $orderItem->order->customer_email, $orderItem->order->customer_name, $params, 'RockDesign Notification');   
                }
            }
