...
use App\Libraries\AWeber;
use App\Models\Customer;
use App\Models\CustomerPasswordReset;
use App\Models\SocialProfile;
use App\Models\LoginAttempt;

use Input, Validator, Redirect, URL, Mail, DB, Session, Socialize, AWeberAPI;
...
class AuthController extends FrontController {
    ...
    public function postForgotPassword()
    {
        ...
        $this->sendMail('emails.forgotPassword', $email, $customer->full_name(), array('token' => $token), 'Password Reset');
    ...
    private function _registerCustomer()
    {
        ...
        $remember   = Input::get('remember') ? true : false;
        $newsletter= Input::get('newsletter') ? YES : NO;
        ...
        $customer->is_subscribed= $newsletter;
        ...
        {
            $aweber = new AWeber(); 
            $aweber->addSubscriber($email);        
        }
        
        // Send register email to customer
        $this->sendMail('emails.register', $email, $customer->full_name(), array('customer' => $customer), 'RockDesign Registration');
