...
// Frontend Routes
{
	...
	Route::any('paypalIPNListener',	'HomeController@paypalIPNListener');
    ...
    Route::any('sample-packs/paypalIPNListener',    ['as' => 'page.sample.pack.ipn',    'uses' => 'SamplePackController@paypalIPNListener']);
    ...
    Route::any('cart/addDesign',            ['as' => 'cart.item.add.design',    'uses' => 'CartController@addDesign']);
    ...
    Route::get('how-to-order.html',         ['as' => 'page.how.order.html',         'uses' => 'StaticPageController@howToOrder']);
    Route::get('print-feature.html',        ['as' => 'page.print.feature.html',     'uses' => 'StaticPageController@printFeature']);
    Route::get('faq.html',                  ['as' => 'page.faq.html',               'uses' => 'StaticPageController@faq']);
    Route::get('file-setup.html',           ['as' => 'page.file.setup.html',        'uses' => 'StaticPageController@fileSetup']);
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'sales', 'as' => 'admin.sales.'], function () {
        ...
        // -- Order
        Route::get('cart',                              ['as' => 'cart.list',       'uses' => 'Admin\Sales\CartController@index']);
        Route::get('cart/detail/{id}',                  ['as' => 'cart.detail',     'uses' => 'Admin\Sales\CartController@detail']);
        Route::post('cart/complete/{id}',               ['as' => 'cart.complete',   'uses' => 'Admin\Sales\CartController@complete']);
        Route::get('cart/item/{id}',                    ['as' => 'cart.item',       'uses' => 'Admin\Sales\CartController@item']);
        Route::get('cart/item/delete/{id}',             ['as' => 'cart.item.delete','uses' => 'Admin\Sales\CartController@deleteItem']);
