...
class Admin extends Model
{
    ...
    {
        return self::where('user_type', USER_STAFF);
    }
    
    public function isAdmin()
    {
        return $this->user_type == USER_ADMIN ? true : false;
    }
    
    public function isStaff()
    {
        return $this->user_type == USER_STAFF? true : false;
    }
     ...
     * @return bool
     */
    public function has_any_permission($permissions=array(), $force=false)
    {
