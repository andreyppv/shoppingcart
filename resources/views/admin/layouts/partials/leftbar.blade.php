        ...
        <div class="sidebar-content">
            ...
            <div class="side-content">
                <ul class="nav-main">
                    ...
                    @if($current_user->has_any_permission(array('sales.order.manage', 'sales.order.view', 'sales.setting.view', 'sales.order.view.assigned', 'sales.customer.view')))
                        <li class="nav-main-heading"><span class="sidebar-mini-hide">Sales</span></li>
                        <li @if($menu == 'sales')class="open"@endif>
                            @if($current_user->has_any_permission(array('sales.order.manage', 'sales.order.view', 'sales.order.view.assigned')))
                            ...
                            @if($current_user->has_any_permission(array('sales.order.manage', 'sales.order.view')))
                                <a @if($page == 'cart')class="active"@endif href="{{ my_route('admin.sales.cart.list') }}"><i class="fa fa-cart-plus"></i><span class="sidebar-mini-hide">Cart ( Pending )</span></a>
                            @endif
