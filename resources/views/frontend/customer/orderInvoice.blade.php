    ...
    <div class="confirm-block block" style="display:block; padding:20px 0;">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 tables-wrap">
                ...
                <p>
                    <span><a target="blank" href="{{ url('/') }}" style="color:#000333;">ROCKDESIGN.COM</a></span>&nbsp;&nbsp;|&nbsp;&nbsp;
                    <span><a target="blank" href="mailto:order@rockdesign.com" style="color:#000333;">order@rockdesign.com</a></span>&nbsp;&nbsp;|&nbsp;&nbsp;
                    <span>Toll Free Number: {{ $settings['site.phone'] }}</span>
                </p>
            </div>
        </div>
    </div>
