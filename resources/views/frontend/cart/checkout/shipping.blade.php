...
{!! Form::open(array('id' => 'shipping-form', 'method' => 'post')) !!}
    <div class="col-md-7">
        ...
        <div class="address-block-row" id="save-address-row" style="<?php if(!$addresses->isEmpty()) { echo "display:none;"; } ?>">
            <div class="left-bl bold">&nbsp;</div>
            <div class="right-bl check-bl">
                <div class="checkbox check-success">
                    {!! Form::checkbox('shipping[save_address]', 1, false, array('id' => 'save_shipping_address', 'readonly')) !!}
                    <label for="save_shipping_address">Save this address</label>
                </div>
            </div>
        </div>
