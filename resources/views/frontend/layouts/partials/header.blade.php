    ...
    <div class="top_menu-wrap">
        ...
        <nav>
            <ul class="menu">
                ...
                <li class="mob-log-block">
                    <!--<div class="search-bl">
                        <img src="{{ asset('frontend/img/serch-icon.svg') }}" alt="search-icon">
                        <input type="text">
                    </div>-->
                    <div class="log-bl">
                        <div class="log-but loginTriger">Sign in</div>
                        <img class="loginTriger" src="{{ asset('frontend/img/login-icon.svg') }}" alt="login-icon">
                    </div>
                </li>
                @endif
                    ...
                    <div class="sub-menu sub-menu-prod">
                        ...
                        <div class="sub-menu-bot">
                            <div class="sub-menu-bot-wrap">
                                ...
                                <span><a href="{{ route('page.corporate.orders.html') }}">Get a Free Quotation Here</a></span>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="menu-parent-item">
                    ...
                    <div class="sub-menu sub-menu-templ">
                        ...
                        <ul class="sub-menu-col last">
                            ...
                            <li><a href="{{ route('page.file.setup.html') }}#download-templates">Download Blank Business Card Templates</a></li>
                ...
                <li class="menu-parent-item">
                    ...
                    <div class="sub-menu sub-menu-quot">
                        <ul class="sub-menu-col last">
                            ...
                            <li><a href="{{ route('page.corporate.orders.html') }}">10+ Names Corporate Ordering</a></li>
                            <li><a href="{{ route('page.corporate.orders.html') }}">Custom Printing Quotation</a></li>
                        </ul>
                ...
                <li class="menu-parent-item last-child">
                    ...
                    <div class="sub-menu sub-menu-support">
                        <ul class="sub-menu-col last">
                            ...
                            <li><a href="{{ route('page.how.order.html') }}">How To Order</a></li>
                            <li><a href="{{ route('page.file.setup.html') }}">File Setup Instruction</a></li>
                            <li><a href="{{ route('page.sample.pack.html') }}">Premium Sample Pack</a></li>
                            <li><a href="{{ route('page.print.feature.html') }}">Print Features</a></li>
                            <li><a href="{{ route('page.faq.html') }}">FAQ</a></li>
                            <li><a href="{{ route('page.corporate.orders.html') }}">Contact Us</a></li>
                ...
                @else
                <li class="mobile-menu-item">
                    <a href="{{ URL::route('customer.main') }}">My Account</a>
                </li> 
                <li class="mobile-menu-item">
