            ...
            <div class="det-ord-bl">
                ...
                <div class="det-ord-cont">
                    {!! Form::open(array('url' => $product->getUploadUrl(), 'id' => 'product-form', 'method' => 'post')) !!}
                        ...
                        <p>Don&rsquo;t forget to check that offset printing is selected if your design requires any coloured or black ink on paper stocks.</p>
                        <br/><br/>
                    
                    {!! Form::close() !!}
                    
                    <p>Ordering for 10+ Names ?</p>
                    <p>Please <a href="{{ route('page.corporate.orders.html') }}">Contact us</a> for Free Quotation</p>
