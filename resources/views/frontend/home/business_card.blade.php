<div class="container section sect1">
    <div class="row">
        <div class="col-md-12 section-title">
            ...
            <h4>IMPRESS YOUR CUSTOMERS WITH STUNNING BUSINESS CARDS</h4>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 with-pad section-foot">
            <div class="button-wrap">
                <a href="{{ route('page.corporate.orders.html') }}">
                    <span class="lg-but more-set-but">LARGE ORDERING ? GET A QUOTE</span>
                </a>
            </div>
            <h2>ROCKDESIGN BUSINESS CARD TEMPLATES</h2>
            <div class="button-wrap">
                <a href="{{ URL::route('template.product.business') }}">
                    <span class="lg-but view-cart-but">VIEW BUSINESS CARD TEMPLATES</span>
                </a>
            </div>
            <h4>HIGH END DESIGN TEMPLATES</h4>
        </div>
    </div>
</div>