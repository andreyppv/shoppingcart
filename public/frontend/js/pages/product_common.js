...
function repositionBubbles() {
    $('#bubbles-box .bubble').each(function() {
...
$(document)
//.off('click', '.share-icons-wrap a.share-btn')
.on('click', '.share-icons-wrap a.share-btn', function(e) {
    //e.stopPropagation();
    e.preventDefault();
...
var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
        ...
        options = {   
            ...
            toggleBubbles: function(item) {
                if(item.loading == true) return;
                
                var containerObj = $(item.container);
                item.loading = true;
